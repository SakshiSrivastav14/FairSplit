FairSplit — Smart & Fair Expense Sharing

**FairSplit** is a lightweight, transparent, and privacy-first web app that helps groups share expenses fairly.  
...
git clone https://github.com/yourusername/fairsplit-mvp.git
cd fairsplit-mvp
